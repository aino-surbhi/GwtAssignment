...
public class CellTableResources_default_InlineClientBundleGenerator implements com.addressbook.GWT.client.cellTable.CellTableResources {
  private static CellTableResources_default_InlineClientBundleGenerator _instance0 = new CellTableResources_default_InlineClientBundleGenerator();
  ...
  private void cellTableStyleInitializer() {
    cellTableStyle = new com.addressbook.GWT.client.cellTable.CellTableResources.TableStyle() {
      ...
      public String getText() {
        return com.google.gwt.i18n.client.LocaleInfo.getCurrentLocale().isRTL() ? ((".GIJQW5EBG{border-top:" + ("2px"+ " " +"solid"+ " " +"#6f7277")  + ";padding:" + ("3px"+ " " +"15px")  + ";text-align:" + ("right")  + ";color:" + ("#4b4a4a")  + ";text-shadow:" + ("#ddf"+ " " +"1px"+ " " +"1px"+ " " +"0")  + ";overflow:" + ("hidden")  + ";}.GIJQW5EBH{border-bottom:" + ("2px"+ " " +"solid"+ " " +"#6f7277")  + ";padding:" + ("3px"+ " " +"15px")  + ";text-align:" + ("right")  + ";color:" + ("#4b4a4a")  + ";text-shadow:") + (("#ddf"+ " " +"1px"+ " " +"1px"+ " " +"0")  + ";overflow:" + ("hidden")  + ";}.GIJQW5EBA{padding:" + ("2px"+ " " +"15px")  + ";overflow:" + ("hidden")  + ";}.GIJQW5EBFB{cursor:" + ("pointer")  + ";cursor:" + ("hand")  + ";}.GIJQW5EBFB:hover{color:" + ("#6c6b6b")  + ";}.GIJQW5EBB{background:" + ("#fff")  + ";}.GIJQW5EBC{border:" + ("2px"+ " " +"solid"+ " " +"#fff")  + ";}.GIJQW5EBBB{background:" + ("#f3f7fb")  + ";}.GIJQW5EBCB{border:" + ("2px"+ " " +"solid"+ " " +"#f3f7fb") ) + (";}.GIJQW5EBI{background:" + ("#eee")  + ";}.GIJQW5EBJ{border:" + ("2px"+ " " +"solid"+ " " +"#eee")  + ";}.GIJQW5EBL{background:" + ("#ffc")  + ";}.GIJQW5EBM{border:" + ("2px"+ " " +"solid"+ " " +"#ffc")  + ";}.GIJQW5EBDB{background:" + ("#628cd5")  + ";color:" + ("white")  + ";height:" + ("auto")  + ";overflow:" + ("auto")  + ";}.GIJQW5EBEB{border:" + ("2px"+ " " +"solid"+ " " +"#628cd5")  + ";}.GIJQW5EBK{border:" + ("2px"+ " " +"solid"+ " " +"#d7dde8")  + ";}.GIJQW5EBAB{margin:") + (("30px")  + ";}.GIJQW5EBH{border-bottom:" + ("2px"+ " " +"solid"+ " " +"#6f7277")  + ";padding:" + ("12px"+ " " +"120px")  + ";text-align:" + ("right")  + ";color:" + ("#4b4a4a")  + ";text-shadow:" + ("#ddf"+ " " +"1px"+ " " +"1px"+ " " +"0")  + ";overflow:" + ("hidden")  + ";}.GIJQW5EBA{color:" + ("black")  + ";padding:" + ("12px"+ " " +"120px")  + ";overflow:" + ("hidden")  + ";}.GIJQW5EBB{background-color:" + ("lightblue") ) + (";}.GIJQW5EBEB{background-color:" + ("lightslategray")  + ";}.GIJQW5EBJ{color:" + ("blue")  + ";background-color:" + ("antiquewhite")  + ";}")) : ((".GIJQW5EBG{border-top:" + ("2px"+ " " +"solid"+ " " +"#6f7277")  + ";padding:" + ("3px"+ " " +"15px")  + ";text-align:" + ("left")  + ";color:" + ("#4b4a4a")  + ";text-shadow:" + ("#ddf"+ " " +"1px"+ " " +"1px"+ " " +"0")  + ";overflow:" + ("hidden")  + ";}.GIJQW5EBH{border-bottom:" + ("2px"+ " " +"solid"+ " " +"#6f7277")  + ";padding:" + ("3px"+ " " +"15px")  + ";text-align:" + ("left")  + ";color:" + ("#4b4a4a")  + ";text-shadow:") + (("#ddf"+ " " +"1px"+ " " +"1px"+ " " +"0")  + ";overflow:" + ("hidden")  + ";}.GIJQW5EBA{padding:" + ("2px"+ " " +"15px")  + ";overflow:" + ("hidden")  + ";}.GIJQW5EBFB{cursor:" + ("pointer")  + ";cursor:" + ("hand")  + ";}.GIJQW5EBFB:hover{color:" + ("#6c6b6b")  + ";}.GIJQW5EBB{background:" + ("#fff")  + ";}.GIJQW5EBC{border:" + ("2px"+ " " +"solid"+ " " +"#fff")  + ";}.GIJQW5EBBB{background:" + ("#f3f7fb")  + ";}.GIJQW5EBCB{border:" + ("2px"+ " " +"solid"+ " " +"#f3f7fb") ) + (";}.GIJQW5EBI{background:" + ("#eee")  + ";}.GIJQW5EBJ{border:" + ("2px"+ " " +"solid"+ " " +"#eee")  + ";}.GIJQW5EBL{background:" + ("#ffc")  + ";}.GIJQW5EBM{border:" + ("2px"+ " " +"solid"+ " " +"#ffc")  + ";}.GIJQW5EBDB{background:" + ("#628cd5")  + ";color:" + ("white")  + ";height:" + ("auto")  + ";overflow:" + ("auto")  + ";}.GIJQW5EBEB{border:" + ("2px"+ " " +"solid"+ " " +"#628cd5")  + ";}.GIJQW5EBK{border:" + ("2px"+ " " +"solid"+ " " +"#d7dde8")  + ";}.GIJQW5EBAB{margin:") + (("30px")  + ";}.GIJQW5EBH{border-bottom:" + ("2px"+ " " +"solid"+ " " +"#6f7277")  + ";padding:" + ("12px"+ " " +"120px")  + ";text-align:" + ("left")  + ";color:" + ("#4b4a4a")  + ";text-shadow:" + ("#ddf"+ " " +"1px"+ " " +"1px"+ " " +"0")  + ";overflow:" + ("hidden")  + ";}.GIJQW5EBA{color:" + ("black")  + ";padding:" + ("12px"+ " " +"120px")  + ";overflow:" + ("hidden")  + ";}.GIJQW5EBB{background-color:" + ("lightblue") ) + (";}.GIJQW5EBEB{background-color:" + ("lightslategray")  + ";}.GIJQW5EBJ{color:" + ("blue")  + ";background-color:" + ("antiquewhite")  + ";}"));
      }
  ...
  private static class cellTableStyleInitializer {
    ...
    static com.addressbook.GWT.client.cellTable.CellTableResources.TableStyle get() {
      return cellTableStyle;
    }
  }
  public com.addressbook.GWT.client.cellTable.CellTableResources.TableStyle cellTableStyle() {
  ...
  private static com.addressbook.GWT.client.cellTable.CellTableResources.TableStyle cellTableStyle;
  ...
  private native ResourcePrototype getResourceNative(String name) /*-{
    switch (name) {
      ...
      case 'cellTableStyle': return this.@com.addressbook.GWT.client.cellTable.CellTableResources::cellTableStyle()();
    }
    return null;
  }-*/;
}
